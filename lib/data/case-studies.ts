...
export const caseStudies: CaseStudy[] = [
  {
    ...
    duration: '5 days',
    overview:
      'Built a complete enterprise-grade SaaS platform for VC portfolio companies with real-time request management, Linear integration, and comprehensive admin dashboards.',
    problem:
      'VC firms needed a centralized system to manage requests from portfolio companies, track progress, and integrate with existing project management tools. The challenge was to build a production-ready multi-tenant application in just 5 days.',
    solution:
      'Developed a full-stack SaaS application using Next.js 15 with Clerk authentication, Prisma ORM, real-time updates via Pusher, and Linear API integration. Implemented multi-tenant architecture with proper data isolation and role-based access control.',
    results: [
    ...
    testimonial: {
      quote:
        'Exceptional work delivered in an incredibly short timeframe. The architecture and implementation quality exceeded our expectations for a 5-day project.',
  ...
  },
  {
    ...
    duration: '2 months',
    overview:
      'Developed an intelligent PostgreSQL migration tool using Ollama AI to automatically convert stored procedures and optimize database schemas with validation and rollback capabilities.',
    problem:
      'Legacy database migrations often require manual conversion of stored procedures and complex schema changes, leading to errors and extended downtime. Traditional tools lack intelligence to understand context and optimize performance.',
    solution:
      'Built an AI-powered migration system that analyzes existing database structures, converts stored procedures intelligently, and provides optimization recommendations. Used Ollama for local AI processing to ensure data privacy and security.',
    results: [
    ...
    testimonial: {
      quote:
        'This tool saved us weeks of manual migration work. The AI-powered conversion is remarkably accurate and the validation features give us confidence in the process.',

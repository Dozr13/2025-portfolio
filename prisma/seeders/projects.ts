...
export const projects: Array<
  Omit<Prisma.ProjectCreateInput, 'category' | 'status'> & {
...
> = [
  {
    ...
    description:
      'Enterprise multi-tenant SaaS platform for VC portfolio companies with real-time request management, Linear integration, and admin dashboards. Built in 5 days as a technical assessment.',
    longDescription:
  ...
  },
  {
    ...
    slug: 'hustleforge',
    description:
      'AI productivity dashboard for managing and optimizing income from side hustles. Built using Flutter, TypeScript, GraphQL, and Firebase with ML-enhanced recommendations.',
    longDescription:
  ...
  },
  {
    ...
    description:
      'This very portfolio! Built with Next.js 15, TypeScript, and Framer Motion. Features responsive design, dark mode, database integration, and optimized performance.',
    longDescription:
  ...
  },
  {
    ...
    slug: 'com-coms',
    description:
      'Real-time care service marketplace with Stripe payments and geo-listings. Led full-stack development using React Native, Expo, and secure mobile deployment practices.',
    longDescription:
    ...
    featured: true,
    demoUrl: null,
    githubUrl: 'https://github.com/Dozr13/com-coms',
    images: JSON.stringify([
      '/projects/com-coms-1.jpg',
      '/projects/com-coms-2.jpg',
      '/projects/com-coms-3.jpg'
    ]),
    thumbnail: '/projects/com-coms-thumb.jpg',

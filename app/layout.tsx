...
export const metadata: Metadata = {
  ...
  description: "Innovative Full Stack Developer specializing in modern web technologies. View my portfolio of cutting-edge projects and get in touch for collaboration opportunities.",

    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="text-lg font-medium mb-2">Skill not found</h3>
        ...
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Update your technical skill: {skillData.name}</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <button
              ...
              onClick={() => {
                if (confirm(`Are you sure you want to delete "${skillData.name}"?`)) {
                  fetch(`/api/admin/skills/${resolvedParams.id}`, {
                    method: 'DELETE',
                    headers: {
